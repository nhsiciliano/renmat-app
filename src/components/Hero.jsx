        ...
        <div className='grid grid-cols-1 lg:grid-cols-2'>
            <div className='my-auto'>
                ...
                <p className='text-[28px] text-gray-700 px-3 text-center lg:text-left md:px-6 mt-2'>
                    Le damos la bienvenida al sitio del <span className='font-semibold text-red-800'>Registro Argentino de Microangiopatías Trombóticas</span>.
                </p>
                <p className='text-[20px] text-gray-800 px-3 md:px-6 mt-5 mb-3'>
                    ...
                    tratan y realizan el seguimiento de pacientes que padecen estas enfermedades.
                </p>
            </div>
            <div>
                <Image
