    ...
    return (
        <div className={styles.container}>
            <div className={styles.left}>
                ...
                <hr />
                <br />
                <h1>Bibliografía disponible para consultar</h1>
                <br />
                <p>Acontinuación brindamos Bibliografía con sus correspondientes links de acceso
                    para que puedan ser consultados de manera completa:
                </p>
            </div>
            <div className={styles.contpaper}>
                {papers.map((item, index) => (
                    <div className={styles.paper} key={index}>
                        <h3>{item.underTitle}</h3>
                        <h2>{item.title}</h2>
                        <h4>{item.authors}</h4>
