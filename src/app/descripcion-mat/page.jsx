...
export default function DescripcionMatPage() {
    return (
        <>
            <PageIntro title="¿Qué son las Microangiopatías Trombóticas?" description="Un grupo de enfermedades con rasgos clínicos y anátomo-patológicos similares, cuyo conocimiento resulta central para el trabajo de la red." />
            <section className="bg-white px-5 py-16 sm:px-8 sm:py-20 lg:px-12 lg:py-24">
                <div className="mx-auto max-w-[1440px]">
                    <div className="grid gap-12 lg:grid-cols-[minmax(360px,0.8fr)_minmax(0,1.2fr)] lg:items-start lg:gap-20">
                    <Reveal>
                    ...
                    <Reveal className="mx-auto mt-16 max-w-[68ch] sm:mt-20">
                        <div className="border-t border-[var(--atlas-line)] pt-10">
                            <h2 className="text-3xl font-extrabold tracking-[-0.025em] text-[var(--atlas-ink)] sm:text-4xl">Púrpura Trombocitopénica Trombótica: PTT y ADAMTS13</h2>
                        ...
                        <div className="mt-12 border-t border-[var(--atlas-line)] pt-10">
                            <h2 className="text-3xl font-extrabold tracking-[-0.025em] text-[var(--atlas-ink)] sm:text-4xl">Síndrome Urémico Hemolítico: SUH típico y atípico</h2>
                        ...
                        <div className="mt-12 rounded-2xl border border-[var(--atlas-line)] bg-[var(--atlas-blue-soft)] p-6 sm:p-8">
                            <h2 className="text-3xl font-extrabold tracking-[-0.025em] text-[var(--atlas-ink)]">Información para Argentina y el registro nacional</h2>
