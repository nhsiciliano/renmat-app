                ...
                <div className="mx-auto grid max-w-[1440px] gap-12 lg:grid-cols-[minmax(360px,0.8fr)_minmax(0,1.2fr)] lg:items-start lg:gap-20">
                    ...
                    <Reveal className="max-w-[76ch]">
                        ...
                        <div className="mt-12 border-t border-[var(--atlas-line)] pt-10">
                            <p className="text-sm font-bold uppercase tracking-[0.13em] text-[var(--atlas-teal-dark)]">Púrpura Trombocitopénica Trombótica</p>
                        ...
                        <div className="mt-12 border-t border-[var(--atlas-line)] pt-10">
                            <p className="text-sm font-bold uppercase tracking-[0.13em] text-[var(--atlas-teal-dark)]">Síndrome Urémico Hemolítico</p>
                        ...
                        <div className="mt-12 rounded-2xl border border-[var(--atlas-line)] bg-[var(--atlas-blue-soft)] p-6 sm:p-8">
                            <p className="text-sm font-bold uppercase tracking-[0.13em] text-[var(--atlas-teal-dark)]">Registro nacional</p>
